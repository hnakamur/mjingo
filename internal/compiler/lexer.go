...
func (s *tokenizerState) span(startLoc loc) *common.Span {
	return &common.Span{
...
func (s *tokenizerState) eatNumber() (token, *common.Span, error) {
...
func (s *tokenizerState) eatIdentifier() (token, *common.Span, error) {
...
func (s *tokenizerState) eatString(delim rune) (token, *common.Span, error) {
	oldLoc := s.loc()
	escaped := false
	hasEscapes := false
...
func (i *tokenizeIterator) Next() (token, *common.Span, error) {

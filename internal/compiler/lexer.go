...
func (s *tokenizerState) span(startLoc loc) *internal.Span {
...
func (s *tokenizerState) eatNumber() (token, *internal.Span, error) {
...
func (s *tokenizerState) eatIdentifier() (token, *internal.Span, error) {
...
func (s *tokenizerState) eatString(delim rune) (token, *internal.Span, error) {
	oldLoc := s.loc()
	escaped := false
	hasEscapes := false
...
func (i *tokenizeIterator) Next() (token, *internal.Span, error) {

...
type spanInfo struct {
	firstInstruction uint32
	span             option.Option[common.Span]
}
...
func (i *Instructions) addWithSpan(instr Instruction, spn common.Span) uint {
	rv := i.add(instr)
...
func (i *Instructions) GetSpan(idx uint) option.Option[common.Span] {
	...
	return option.None[common.Span]()
}

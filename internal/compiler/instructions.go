...
type spanInfo struct {
	firstInstruction uint32
	span             option.Option[internal.Span]
}
...
func (i *Instructions) addWithSpan(instr Instruction, spn internal.Span) uint {
	rv := i.add(instr)
...
func (i *Instructions) GetSpan(idx uint) option.Option[internal.Span] {
	...
	return option.None[internal.Span]()
}

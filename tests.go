...
type argType[O any] interface {
	fromValue(val option[value]) (O, error)
	fromStateAndValue(state *virtualMachineState, val option[value]) (argConvertResult[O], error)
	fromStateAndValues(state *virtualMachineState, values []value, offset uint) (argConvertResult[O], error)
	isTrailing() bool
}
...
func tuple3FromValues[AO any, BO any, CO any, A argType[AO], B argType[BO], C argType[CO]](state *virtualMachineState, values []value) (tuple3[AO, BO, CO], error) {
...
func tuple4FromValues[AO any, BO any, CO any, DO any, A argType[AO], B argType[BO], C argType[CO], D argType[DO]](state *virtualMachineState, values []value) (tuple4[AO, BO, CO, DO], error) {
...
func tuple5FromValues[AO any, BO any, CO any, DO any, EO any,
	...
	E argType[EO]](state *virtualMachineState, values []value) (tuple5[AO, BO, CO, DO, EO], error) {
